  ...
  <div class="accountPage accountInfo pageReduced">
    <div class="containerReduced">
      ...
      <div class="col-12 col-md-12 order-3">
        ...
        <p v-if="!success" v-html="accountinfo.subtitle">
        ...
        >
          <div class="row">
            <div class="col-12 col-md-6">
              <div
                class="input_group"
                :class="cont_name_account_error === true ? 'error' : ''"
              >
                <input
            ...
            <div class="col-12 col-md-6">
              <div
                class="input_group"
                :class="cont_surname_account_error === true ? 'error' : ''"
              >
                <input
            ...
            <div class="col-12 col-md-6">
              <div
                class="input_group"
                :class="cont_phone_account_error === true ? 'error' : ''"
              >
                <input
            ...
            <div class="col-12 col-md-6">
              <div
                class="input_group"
                :class="cont_country_account_error === true ? 'error' : ''"
              >
                <select
            ...
            <div class="col-12 col-md-6">
              <div
                class="input_group"
                :class="cont_password_account_error === true ? 'error' : ''"
              >
                <input
                ...
                <ul class="passwordValidationRules">
                  <li v-for="(error, i) in passwordValidation.errors" :key="i">
                    {{ error }}
                  </li>
                </ul>
              </div>
