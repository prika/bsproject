    ...
    <div class="containerReduced">
      ...
      >
        <div>
          ...
          <p class="subtitle" v-if="!success" v-html="accountrecovery.subtitle">
          ...
          >
            <div class="row d-flex align-items-center">
              <div class="col-12 col-md-7">
                <div
                  class="input_group"
                  :class="cont_email_recovery_error === true ? 'error' : ''"
                >
                  <input
              ...
              <div class="col-12 col-md-7">
                <button
                  ...
                  :aria-label="accountrecovery.submit"
                >
          ...
          >
            <div v-if="success">
              <p v-html="accountrecovery.success">
