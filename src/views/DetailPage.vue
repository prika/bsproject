		...
		>
			<div class="productDetailLinks col-8" key="1" v-if="!showDetail">
				<a href="javascript:void(0)" @click="showDetail = !showDetail">
					...
					<sup class="variantsquantity">({{ product.variants.length }})</sup>
				</a>
			...
			<div class="productVariationList col-12 col-md-10 col-lg-9" key="2" v-if="showDetail">
				<div class="filters col-12 col-lg-8 col-xl-6">
					...
					<div class="pagination">
						<a v-if="hasPrevLink" href="javascript:void(0)" @click="prevPageClick()" class="arrowLeft">
							<arrowRightIcon />
						</a>
						<p>
						...
						<a v-if="hasNextLink" href="javascript:void(0)" @click="nextPageClick()" class="arrowRight">
							<arrowRightIcon />
						</a>
					</div>
				</div>
								...
								<div class="info row">
									...
									<div class="col-12 col-md-4">
										<p>
											...
											<br />
											{{ variant.weight }} {{ $t("units_ton_abrev") }}
										</p>
									</div>
								</div>
							</router-link>
