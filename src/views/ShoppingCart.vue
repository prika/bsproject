<template>
  <div id="shoppingCartPage">
    ...
    >
      <div class="row justify-content-center" v-if="checkoutStep == 1">
        ...
        <div class="cartTable col-12 col-md-9 col-lg-8">
          ...
          <div
            class="categoryGroup"
            v-for="(container, cat) in categoryContainers"
            :key="cat"
          >
            <div class="row">
              <p class="col-12 col-md-8 text-center text-md-left">
                <span class="categoryTitle uppercase"
                  >{{ container.category }}
                </span>
              ...
              <p class="col-12 col-md-4 text-center containerInfo">
                ...
                {{ container.containerDimensions }}m<sup>2</sup>
              </p>
            </div>
            ...
            <div
              class="categoryRow"
              v-for="(item, index) in container.containerItems"
              :key="index"
            >
              <p
                v-if="isMobile()"
                class="categoryContainerMobile col-12 text-center d-block d-sm-none"
              >
              ...
              <div
                class="categoryContainer text-center d-none d-md-block col-sm-4"
              >
                <chartContainer
    ...
    <transition
      enter-class="animated slideInRight"
      leave-active-class="animated slideOutLeft"
    >
...
export default {
  ...
  created() {
    this.$http
      .get("http://localhost:8080/mocks/cart-list-mock.json")
      .then((response) => {
