<template>
	<div id="bannerAnimation">
		...
		<svg
			v-if=" name == 'listpage-categories' || name == 'listpage-collection' || name ==  'productDetail' || name ==  'productDetail2' || name == 'variantDetail' "
			v-once
		...
		<svg
			v-if=" name == 'news' || name == 'newsdetail' || name == 'shoppingcart'"
			v-once
			:alt="'Preloading'+name"
			xmlns="http://www.w3.org/2000/svg"
			width="200"
