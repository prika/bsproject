<template>
  <div id="bannerAnimation" v-once>
    <svg id="animatedlogo" v-if=" name == 'Home'" alt="Preloading B Stone">
        <g id="Rreferencias">
    ...
    <svg v-if=" name == 'listpage' || name ==  'productDetail' || name == 'variantDetail' " alt="Preloading Bloco B" data-name="Logo BLOCO" xmlns="http://www.w3.org/2000/svg" width="627.63" height="167.26" viewBox="0 0 627.63 167.26">
    ...
    <svg v-if=" name == 'explore'" xmlns="http://www.w3.org/2000/svg" width="887.789" height="205.738" viewBox="0 0 887.789 205.738">
    ...
    <svg v-if=" name == 'innovation'" alt="Preloading B Innovation" xmlns="http://www.w3.org/2000/svg" width="1266.265" height="171.105" viewBox="0 0 1266.265 171.105">
    ...
    <svg v-if=" name == 'project'" alt="Preloading B Project" xmlns="http://www.w3.org/2000/svg" width="866.935" height="205.738" viewBox="0 0 866.935 205.738">
