<template>
    <div id="bannerAnimation">
      ...
      <svg id="animatedlogo" v-if=" name == 'Home'" alt="Preloading B Stone">
          ...
          <svg v-if=" name == 'innovation'" alt="Preloading B Innovation" data-name="Grupo 427" xmlns="http://www.w3.org/2000/svg" width="1266.265" height="171.105" viewBox="0 0 1266.265 171.105">
          ...
          <svg v-if=" name == 'project'" alt="Preloading B Project" data-name="Grupo 426" xmlns="http://www.w3.org/2000/svg" width="866.935" height="205.738" viewBox="0 0 866.935 205.738">
