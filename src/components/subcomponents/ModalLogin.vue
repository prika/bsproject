<template>
  <div class="modalLogin">
    ...
    <div v-if="!success && !isLoggedIn" class="formLogin revertColor">
      <p class="h1 col-12" v-html="accountlogin.title">
        {{ accountlogin.title }}
      </p>
      ...
      <form id="login" @submit.prevent="checkLoginForm" class="col-12">
        <div
          class="input_group"
          :class="cont_email_login_error === true ? 'error' : ''"
        >
          <input
            id="cont_email_login"
        ...
        <div
          class="input_group"
          :class="cont_password_login_error === true ? 'error' : ''"
        >
          <input
    ...
    <div v-if="isLoggedIn" class="formLogin revertColor">
      ...
      <router-link to="/account" class="passwordRecoveryLink col-12"
