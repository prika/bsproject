            ...
            <div class="carousel-inner">
                ...
                <template v-for="(image, index) in imageGroupSliderGallery">
                    ...
                    <div v-if="image.type == 'img'" :class="['carousel-item', (index === 0 ? 'active': '')]">
                        <img :src="image.src" 
                            :alt="image.alt" class="d-block">
                    </div>

                    <!-- Video Mp4 -->
                    <vue-plyr v-if="image.type == 'video-uploaded'" :class="['carousel-item', (index === 0 ? 'active': '')]" :ref="'player'+index">
                    ...
                    <!-- Video Youtube -->
                    <vue-plyr v-if="image.type == 'video-youtube'" :class="['carousel-item', (index === 0 ? 'active': '')]" :ref="'player'+index">
                    ...
                    <!-- Video Vimeo -->
                    <vue-plyr v-if="image.type == 'video-vimeo'" :class="['carousel-item', (index === 0 ? 'active': '')]" :ref="'player'+index">
                        <div class="plyr__video-embed">
                            <iframe :alt="image.alt"
                                    :poster="image.src"
                                    :src="image.srcvideo"
