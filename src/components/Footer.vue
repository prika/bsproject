...
<footer>
    <div class="container">
            ...
            <div class="col-8 cofinancedby">
                <div class="row">
                    <div class="col-md-6 centered-sm centered-xs">
                        <a href="assets/Alentejo2020x.pdf" class="cofinance1" target="_blank" rel="noreferrer" aria-label="Co-financed by: Alentejo 2020"></a>
                    </div>

                    <div class="col-md-6 centered-sm centered-xs">
                        <a href="assets/Compete2020x.pdf" class="cofinance2" target="_blank" rel="noreferrer" aria-label="Co-financed by: Compete 2020"></a>
                    </div>
                </div>
            </div> 
        ...
        <div class="row">
            <div class="logoFooter col-6 centered-sm centered-xs"></div>
            <div class="col-4">
                <p>Copyright 2019 Bloco B</p>
                <p>Website by <a href="">inCentea MI</a></p> 
            </div>
        </div>
...
footer{
  ...
  color: #FFF;
      ...
      .logoFooter{
        ...
        /* width: 210px; */
        height: 50px;
        background: url(../assets/images/footer/logo_footer.svg) no-repeat 20px;
      }
      ...
      .social-icons{
          ...
          a {
              ...
              background-color: #666;
                ...
                &.fb{
                    /* background: url(assets/images/social/icon_face.svg) no-repeat center center; */
                ...
                &.in{
                    /* background: url(assets/images/social/icon_Insta.svg) no-repeat center center */
                ...
                &.pi{
                    /* background: url(assets/images/social/icon_Pint.svg) no-repeat center center */
                ...
                &.yt{
                  /* background: url(assets/images/social/icon_Youtube.svg) no-repeat center center */
                ...
                &.lk{
                  /* background: url(assets/images/social/icon_linkedin.svg) no-repeat center center */
...
.container.cofinancedby{
    ...
    & > a{
      ...
      display: block;
      text-decoration: none;
      background: url(../assets/images/footer/cofinanced1.svg) no-repeat;
      opacity: .7;

      &.cofinance2{
        background: url(../assets/images/footer/cofinanced2.svg) no-repeat;
        float: right;
      }
...
@media (max-width: 980px) { 
    .container.cofinancedby a.cofinance1,
    .container.cofinancedby a.cofinance2{
        float: none;
        margin: 15px auto 0;
    }
}
